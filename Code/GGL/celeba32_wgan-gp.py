...
#     model = torchvision.models.resnet18(pretrained=args.trained_model)
    ...
    model1 = BigGAN.from_pretrained('biggan-deep-256')
    # Define the path and filename for the saved model
    save_path = '/Users/manandkrishna/Documents/s2/VisualComputing/GGL/model.pth'

    # Save the model state dictionary to the specified path and filename
    ...
    print('LPIPS score : {:.3f}, LPIPS score : {:.3f}, MSE: {:.5f}, PSNR: {:.3f}, FMSE: {:.5f}, RMSE: {:.5f}, TV of original: {:.3f}, TV of reconstructed: {:.3f}'.format(lpips_score, lpips_score_a, mse, psnr_score, feat_mse, rep_mse, tv_o, tv_r))
